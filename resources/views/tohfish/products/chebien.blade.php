...
@section('title', 'Sản Phẩm Chế Biến - TOH fish')
...
<section class="products-section py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-title text-center mb-5">Sản Phẩm Chế Biến</h1>
                <p class="text-center text-muted mb-5">Các món cá đã chế biến thơm ngon, đậm đà hương vị</p>
            </div>
        </div>
        <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-card product-card-processed">
                        ...
                        <div class="product-info" style="margin-top: 12px;">
                            <h5 class="product-name"><a href="{{ route('product.detail', $product->images_id ?? ($index + 1)) }}" style="text-decoration: none; color: inherit;">{{ $product->content ?? 'Sản phẩm chế biến ' . ($index + 1) }}</a></h5>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <form action="{{ route('cart.add') }}" method="POST" class="d-inline flex-grow-1 me-1">
                                    ...
                                    <input type="hidden" name="name" value="{{ $product->content ?? 'Sản phẩm chế biến ' . ($index + 1) }}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="product-card product-card-processed">
                    ...
                    <div class="product-info" style="margin-top: 12px;">
                        <h5 class="product-name"><a href="{{ route('product.detail', $i) }}" style="text-decoration: none; color: inherit;">Sản phẩm chế biến {{ $i }}</a></h5>
                        <p class="product-price">139,000₫</p>
                        <form action="{{ route('cart.add') }}" method="POST">
                            @csrf
                            <input type="hidden" name="product_id" value="{{ $i }}">
                            <input type="hidden" name="name" value="Sản phẩm chế biến {{ $i }}">
