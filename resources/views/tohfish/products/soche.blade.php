...
@section('title', 'Sản Phẩm Sơ Chế - TOH fish')
...
<section class="products-section py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-title text-center mb-5">Sản Phẩm Sơ Chế</h1>
                <p class="text-center text-muted mb-5">Các sản phẩm cá tươi sống, đảm bảo chất lượng</p>
            </div>
        </div>
        <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-card">
                        ...
                        <div class="product-info" style="margin-top: 12px;">
                            <h5 class="product-name"><a href="{{ route('product.detail', $product->images_id ?? ($index + 1)) }}" style="text-decoration: none; color: inherit;">{{ $product->content ?? 'Tôm Sú Cồ thiên nhiên 100g/gói' }}</a></h5>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <form action="{{ route('cart.add') }}" method="POST" class="d-inline flex-grow-1">
                                    ...
                                    <input type="hidden" name="name" value="{{ $product->content ?? 'Tôm Sú Cồ thiên nhiên 100g/gói' }}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h5 class="product-name"><a href="{{ route('product.detail', $i) }}" style="text-decoration: none; color: inherit;">Tôm Sú Cồ thiên nhiên 100g/gói</a></h5>
                        <p class="product-price">135,000₫</p>
                        <form action="{{ route('cart.add') }}" method="POST">
                            @csrf
                            <input type="hidden" name="product_id" value="{{ $i }}">
                            <input type="hidden" name="name" value="Tôm Sú Cồ thiên nhiên 100g/gói">
