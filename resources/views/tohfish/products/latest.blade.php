...
@section('title', 'Sản phẩm mới nhất - TOH fish')
...
<section class="products-section py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-title text-center mb-4">Sản phẩm mới nhất</h1>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body" id="filterContent" style="display: none;">
                        <form method="GET" action="{{ route('products.latest') }}" id="filterForm">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a href="{{ route('products.latest') }}" class="btn btn-outline-secondary w-100">
        ...
        <div class="row">
            @if(isset($products) && $products->isNotEmpty())
                @php
                    ...
                    $perPage = method_exists($products, 'perPage') ? $products->perPage() : 8;
                    $globalIndex = ($currentPage - 1) * $perPage;
                @endphp
                ...
                @php
                    ...
                    $originalPrice = $product->price ?? 135000;
                    ...
                    $discountPrice = $discountPercent > 0 
                        ...
                        : $originalPrice;
                    // Chỉ hiển thị badge "MỚI" cho 8 sản phẩm đầu tiên (trang 1) và không có giảm giá
                    $showNewBadge = ($currentPage == 1 && $index < 8) && $discountPercent == 0;
                @endphp
                <div class="col-lg-3 col-md-3 col-sm-6 mb-4">
                    <div class="product-card">
                        ...
                        <div class="product-info" style="margin-top: 12px;">
                            <h5 class="product-name"><a href="{{ route('product.detail', $product->images_id ?? ($index + 1)) }}" style="text-decoration: none; color: inherit;">{{ $product->content ?? 'Sản phẩm mới nhất ' . ($index + 1) }}</a></h5>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <form action="{{ route('cart.add') }}" method="POST" class="d-inline flex-grow-1 add-to-cart-form" onsubmit="return false;">
                                    ...
                                    <input type="hidden" name="name" value="{{ $product->content ?? 'Sản phẩm mới nhất ' . ($index + 1) }}">
