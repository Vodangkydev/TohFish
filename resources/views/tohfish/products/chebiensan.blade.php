...
@section('title', 'Sản Phẩm Chế Biến Sẵn - TOH fish')
...
<section class="products-section py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-title text-center mb-5">Sản Phẩm Chế Biến Sẵn</h1>
                <p class="text-center text-muted mb-5">Thực phẩm chế biến sẵn tiện lợi, thơm ngon</p>
            </div>
        </div>
        <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-card">
                        ...
                        <div class="product-info" style="margin-top: 12px;">
                            <h5 class="product-name"><a href="{{ route('product.detail', $product->images_id ?? ($index + 1)) }}" style="text-decoration: none; color: inherit;">{{ $product->content ?? 'Sản phẩm chế biến sẵn ' . ($index + 1) }}</a></h5>
                            ...
                            @endif
                            <p class="product-price">{{ number_format($product->price ?? 128000, 0, ',', '.') }}₫</p>
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <form action="{{ route('cart.add') }}" method="POST" class="d-inline flex-grow-1">
                                    ...
                                    <input type="hidden" name="name" value="{{ $product->content ?? 'Sản phẩm chế biến sẵn ' . ($index + 1) }}">
                                    <input type="hidden" name="price" value="{{ $product->price ?? 128000 }}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="product-card">
                    ...
                    <div class="product-info" style="margin-top: 12px;">
                        <h5 class="product-name"><a href="{{ route('product.detail', $i) }}" style="text-decoration: none; color: inherit;">Sản phẩm chế biến sẵn {{ $i }}</a></h5>
                        <p class="product-price">128,000₫</p>
                        <form action="{{ route('cart.add') }}" method="POST">
                            @csrf
                            <input type="hidden" name="product_id" value="{{ $i }}">
                            <input type="hidden" name="name" value="Sản phẩm chế biến sẵn {{ $i }}">
                            <input type="hidden" name="price" value="128000">
